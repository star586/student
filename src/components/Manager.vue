<template>
    <div>
        <div id="conent">
            <h1>四川师范大学数字迎新系统</h1>
            <input type="button" id="search" @click="toFindById"/>
            <div id="top">
                <div class="part1">
                    <div class="dao1" @click="toPay">现场缴费</div>
                    <div class="dao1" @click="toReport">现场报道</div>
                    <div class="dao1" @click="toStatus">学生状态</div>
                    <div class="dao1" @click="toHome">首页</div>
                </div>
                <div id="part3">
...
export default {
    ...
    methods:{
        ...
        toStatus(){
            this.$router.push('/manager/status');
        },
        toPay(){
