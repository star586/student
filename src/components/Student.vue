<template>
    <div>
        <div id="conent">
            ...
            <div id="top">
                <div class="part1">
                    <div id="dao1" @click="toTuition">学费支付</div>
                    <div id="dao1" @click="toAffair">事务处理</div>
                    <div id="dao1" @click="toReport">学生报道</div>
                    <div id="dao1" @click="toInformation">学生信息</div>
                    <div id="dao1" @click="toStrategy">校园攻略</div>
                    <div id="dao1" @click="toHome">首页</div>
                </div>
                <div class="part2">
                    <div id="dao2">
...
export default {
    ...
    methods:{
        ...
        toAffair(){
            this.$router.push('/student/affair');
        },
        toInformation(){
        ...
        toStrategy(){
            this.$router.push('/student/strategy');
        }
    }
}
</script>
