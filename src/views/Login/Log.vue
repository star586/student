                ...
                if (this.userFlag === 1 && this.pawFlag === 1) {
                    ...
                    this.axios.post("/login",qs.stringify(obj),{
                        ...
                        if(res.data.msg!="登录成功"){
                            ...
                            var list=res.data.detail.list;
                            var url=res.data.detail.url;
                            this.$store.commit("setId",{id:this.username,list:list,url:url});
                            // if(list[0].code==1){
                            //     this.$router.push(list[0].link);
                            // }else if(list[6].code==1){
                            //     this.$router.push(list[6].link);
                            // }else{
                                console.log(url)
