<template>
    <div class="whole">
        ...
        <el-form label-width="60px" :inline="true" :model="ma">
            <el-row>
                ...
                <el-form-item label="专业">
                    <el-select v-model="ma.major" placeholder="请选择相应的专业">
        ...
        <el-table :header-row-style="getRowClass" :row-style="getRowClass" :header-cell-style="{textAlign:'center'}"
            ...
            <el-table-column prop="operation" label="操作" width="108">
                <template slot-scope="scope">
                    <!-- <a @click="deTails(scope.row)" style="color:blue;cursor:pointer"></a> -->
